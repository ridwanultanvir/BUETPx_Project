...
class ClassInformation:
    ...
    def loadData(self, className:str, jsonValue:QtCore.QJsonValue):
        ...
        # print("ClassInformation: loadData: label: ", self.m_label)
...
class ClassRules:
    def __init__(self):
        ...
        jsonFile = QtCore.QFile(os.path.join(self.m_executionPath, "testform/image_tag/Model/imagenet_class_rules.json"))
